          ...
          {loading ? (
            ...
            <>
              ...
              {activeTab === 'logs' && (
                <div>
                  <p className="mb-4 text-xs text-gray-500">
                    {priorityLogs.length} movimentaç{priorityLogs.length !== 1 ? 'ões' : 'ão'} registrada{priorityLogs.length !== 1 ? 's' : ''}
                  </p>
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="text-left text-[10px] uppercase tracking-widest text-gray-600">
                  ...
                  {priorityLogs.length === 0 && (
                    <p className="mt-8 text-center text-sm text-gray-600">Nenhuma movimentação registrada ainda.</p>
                  )}
                </div>
              )}
