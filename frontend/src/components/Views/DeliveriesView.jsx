...
export default function DeliveriesView({ initiatives }) {
  ...
  // KPIs com blindagem total contra NaN e undefined
  ...
  const accumulatedNetGains = filtered.reduce((s, i) => {
    ...
    const monthlyNetGain = Number(i.metrics?.total_gains || 0)
    return s + (monthlyNetGain * (isNaN(monthsLive) ? 0 : monthsLive))
  }, 0)
  ...
  // Charts data com tratamento de undefined
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        <HeroKpi
          ...
          color="#6BFFEB"
          icon="💰"
          tooltip="Projeção anual baseada na soma dos ganhos líquidos mensais de todas as entregas concluídas."
        />
        <HeroKpi
        ...
        <HeroKpi
          ...
          color="#40EB4F"
          icon="📈"
          tooltip="Média do ROI mensal das iniciativas entregues."
        />
        <HeroKpi
        ...
        <HeroKpi
          ...
          color="#F2F24B"
          icon="🗓️"
          tooltip="Média de dias entre a data de início e a data de conclusão das iniciativas."
        />
      </div>
